...
var InputFieldTypes = /* @__PURE__ */ ((InputFieldTypes2) => {
  InputFieldTypes2["checkbox"] = "checkbox";
  InputFieldTypes2["color"] = "color";
  InputFieldTypes2["date"] = "date";
  InputFieldTypes2["datetimeLocal"] = "datetime-local";
  InputFieldTypes2["email"] = "email";
  InputFieldTypes2["file"] = "file";
  InputFieldTypes2["month"] = "month";
  InputFieldTypes2["number"] = "number";
  InputFieldTypes2["password"] = "password";
  InputFieldTypes2["radio"] = "radio";
  InputFieldTypes2["range"] = "range";
  InputFieldTypes2["search"] = "search";
  InputFieldTypes2["tel"] = "tel";
  InputFieldTypes2["text"] = "text";
  InputFieldTypes2["time"] = "time";
  InputFieldTypes2["url"] = "url";
  InputFieldTypes2["week"] = "week";
  return InputFieldTypes2;
})(InputFieldTypes || {});
...
// src/scripts/inputFile.ts
var COMPONENT_CLASS2 = " staark-component-file-input";
var inputFile = (state, attributes, label) => {
  state = Object.assign({
    files: []
  }, state);
  attributes.class = (attributes.class || "") + COMPONENT_CLASS2;
  ...
  return [
    ...
    node("label", {
      ...
      drop: (event) => {
        var _a;
        event.preventDefault();
        state.files = (_a = event.dataTransfer) == null ? void 0 : _a.files;
        if (onChange) {
          onChange(event);
        }
      }
...
var inputList = (state, options, items) => {
  ...
  return node2("fieldset", fieldAttributes, contents);
};

// src/scripts/router.ts
var router = (routes, state, options = {}) => {
  var _a;
  state = Object.assign({
    route: (_a = options.initial) != null ? _a : ""
  }, state);
  return node2("div");
};
export {
...
//# sourceMappingURL=staark-components.js.map
